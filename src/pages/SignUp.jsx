    ...
    try {
      ...
      try {
        ...
        if (!isFirebaseAuthFallbackError(fbErr)) {
          console.warn("Firebase Auth registration failed, relying on server fallback...", fbErr);
        }
      }
      ...
      if (err.code === "auth/email-already-in-use" || err.message?.includes("already registered") || err.message?.includes("email-already-in-use")) {
