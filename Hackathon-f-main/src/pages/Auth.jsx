    ...
    <div className="w-full max-w-lg bg-white border border-gray-200 backdrop-blur-xl p-8 rounded-3xl z-10 shadow-2xl relative">
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        <button
          ...
          disabled={loading}
          className="flex items-center justify-center gap-1.5 bg-gray-50 hover:bg-gray-100 border border-gray-200 text-gray-800 font-semibold py-2.5 px-2 rounded-xl transition-all text-xs cursor-pointer focus:outline-none"
      ...
      {!isPhoneMode && (
        <div className="relative my-5 text-center">
          ...
          <span className="relative bg-[#0f172a] px-3.5 text-[9px] font-bold text-gray-450 uppercase tracking-widest">or use secure credentials</span>
        </div>
      )}
        ...
        <div className="space-y-4">
          ...
          {!otpSent ? (
            <form onSubmit={handleSendOtp} className="space-y-4">
              <div>
                <label className="block text-[10px] uppercase font-bold tracking-wider text-gray-500 mb-1.5">Mobile Phone Number</label>
                <div className="relative">
                  <Phone className="absolute left-3.5 top-3 w-4 h-4 text-gray-450" />
                  <input
                    type="tel"
                    required
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-500 hover:to-blue-500 text-gray-900 font-bold py-3 rounded-xl transition-all shadow-lg shadow-indigo-600/20 text-xs flex items-center justify-center gap-2 cursor-pointer mt-4"
              >
                {loading ? (
                  <>
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-4">
              <div>
                <label className="block text-[10px] uppercase font-bold tracking-wider text-gray-500 mb-1.5">Enter 6-Digit OTP Code</label>
                <div className="relative">
                  <Smartphone className="absolute left-3.5 top-3 w-4 h-4 text-gray-450" />
                  <input
                    type="text"
                    required
                    maxLength={6}
                    ...
                    className="w-full bg-gray-50 border border-gray-200 rounded-xl py-2.5 pl-11 pr-4 text-xs focus:border-indigo-500 focus:outline-none transition-colors text-gray-900 text-center tracking-widest font-mono text-lg"
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-gray-900 font-bold py-3 rounded-xl transition-all shadow-lg shadow-emerald-600/20 text-xs flex items-center justify-center gap-2 cursor-pointer mt-4"
              >
                {loading ? (
                  <>
                    <Loader className="w-3.5 h-3.5 animate-spin" />
          ...
          <button
            ...
            className="w-full text-center text-gray-500 hover:text-gray-800 text-xs pt-2 font-semibold"
          >
